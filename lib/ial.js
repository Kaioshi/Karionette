...
module.exports = function (config) {
	...
	function remChannel(chan) {
		console.log("remChannel");
	...
	function remUser(nick) { // probably wont be used, prefer userLeft/userQuit
		console.log("remUser");
		delete users[nick];
	}
