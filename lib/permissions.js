...
permissions = {
	...
	Info: function (from, type, item) {
		...
		if (from && type.match(/plugin|function|alias|variable/i) && item) {
			...
			if (this.isOwner(type, item, from)) {
				if (entry[item]["owner"] && entry[item]["owner"].length > 0) {
	...
	Allow: {
		Syntax: "[Help] Syntax: permissions allow <add/remove/list> <function/plugin/alias/variable> <function/etc name> <user!mask@*.host.org>",
		Example: "Example: permissions allow add function ud mitch_!*@*.se",
	...
	Deny: {
		Syntax: "[Help] Syntax: permissions deny <add/remove/list> <function/plugin/alias/variable> <function/etc name> <user!mask@*.host.org>",
		Example: "Example: permissions deny add function ud mitch_!*@*.se",
		Add: function (from, type, item, mask) {
	...
	Owner: {
		Syntax: "[Help] Syntax: permissions owner <add/remove/list> <alias/variable> <alias/variable name> <user!mask@*.host.org>",
		Example: "Example: permissions owner add variable anime_list mitch_!*@*.se",
		Add: function (from, type, item, mask) {
			var ret;
	...
	Admin: {
		Syntax: "[Help] Syntax: permissions admin <add/remove/list> <Nick> [<user!mask@*.host.org>]",
		Example: "Example: permissions admin add mitch_ mitch_!*@dreams.of.mem.es -- permissions admin list -- permissions admin list Nick (to show their masks)",
